...
function _train_loss(field::SVGPField, trajs, ms::Magpie.MultipleShooting, tspan; kw...)
...
function _train_init(field::SVGPField, trajs, ms::Magpie.MultipleShooting)
    tu = only(trajs)
    return _init_vec(field, tu[2], tu[1], ms)
end
